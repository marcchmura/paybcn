...
export default async function CheckoutPage({ params }) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 lg:px-8 py-12 flex items-start space-y-6 flex-col w-full sm:w-[400px]">
      ...
      <p className="text-sm text-muted-foreground">Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt repellendus modi facere illo architecto repudiandae tempora officiis aspernatur.</p>
    </div>
  );
}
*/