...
// Explicitly type the uuid parameter
...
// Explicitly type the params prop here
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 lg:px-8 py-12 flex items-start space-y-6 flex-col w-full sm:max-w-5xl">
      <div className="flex justify-between items-center w-full">
        <h3 className="text-2xl tracking-tight text-pretty line-clamp-2 text-ellipsis overflow-hidden">{t("title")}</h3>
      </div>
      <div className="flex flex-col md:flex-row justify-between md:space-x-12 space-y-6 md:space-y-0 w-full md:w-auto">
        <div className="flex flex-col md:w-1/2 space-y-6">
          <div className="space-y-2 flex flex-col w-full">
            <div className="flex justify-between w-full">
              <Label>{t("contact-heading")}</Label>
        ...
        <div className="flex flex-col space-y-8 md:w-1/2">
          <div className=" flex justify-start items-start flex-col space-y-8 rounded-xl w-full">
            <div className="mx-auto w-full">
              ...
              <dl>
                <dt className="text-sm font-medium">{t("amount-due")}</dt>
              ...
              <ul role="list" className="text-sm">
                <li className="flex items-start space-x-4 pt-4">
                  <div className="flex-auto space-y-1">
                    <h3 className=" font-regular">{t("subtotal")}</h3>
                  </div>
                ...
                <li className="flex items-start space-x-4 py-4">
                  <div className="flex-auto space-y-1">
                    <h3 className=" font-regular">{t("transaction-fee")}</h3>
                  </div>
                  <p className="flex-none text-sm font-medium">
                    {symbol}
                    {transaction_fee}
            ...
            <p className="text-xs/5 text-muted-foreground">{t("disclaimer")}</p>
          </div>
        </div>
      </div>
    </div>
